<template>
    <div>
        <v-stepper-step step="3" :complete="step > 3">Обязательные платежи</v-stepper-step>
...
import penaltyItem from '@/components/home/formStep3Penalty.vue';
import taxItem from '@/components/home/formStep3Tax.vue';
export default {
    components: {
        penaltyItem,
        taxItem
