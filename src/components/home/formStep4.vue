<template>
    <div>
        <v-stepper-step step="4" :complete="step > 4">Имущество</v-stepper-step>
...
import realtyItem from '@/components/home/formStep4Realty.vue';
import movableItem from '@/components/home/formStep4Movable.vue';
export default {
    components: {
        realtyItem,
        movableItem
